...
#ifndef LFS_DEBUG
#ifndef LFS_NO_DEBUG
#define LFS_DEBUG(fmt, ...) lfs_debug_print(__FILE__, __LINE__, fmt, __VA_ARGS__)
#else
#define LFS_DEBUG(...)
#endif
#endif
...
#ifndef LFS_WARN
#ifndef LFS_NO_WARN
#define LFS_WARN(fmt, ...) lfs_warn_print(__FILE__, __LINE__, fmt, __VA_ARGS__)
#else
#define LFS_WARN(...)
#endif
#endif
...
#ifndef LFS_ERROR
#ifndef LFS_NO_ERROR
#define LFS_ERROR(fmt, ...) lfs_error_print(__FILE__, __LINE__, fmt, __VA_ARGS__)
#else
#define LFS_ERROR(...)
#endif
#endif
